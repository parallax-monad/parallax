...
Status: TEMPORARY FORK PIN LOCKED; LIVE SIMULATION SUCCEEDED ON THE PIN — EVIDENCE PENDING NODE v22.23.2 REGENERATION
...
| Property | Value |
| --- | --- |
| Parallax commit (branch head) | `3a74c4bd80192145c7c878a5357bab3b4c0136de` (`feat/moss-fork-pinned-runtime`); the committed fixture was generated by `dd4912b` |
...
| Node | **v22.23.2 (contract pin)** (downloaded from nodejs.org `v22.23.2`, darwin-arm64 tarball). The currently committed live fixture was generated under Node v24.14.0 and is **SUPERSEDED_PENDING_NODE22_REGEN**: it must be regenerated by a real live smoke running under Node v22.23.2 before it counts as merge evidence |
...
The next real Node v22.23.2 run regenerates the formal fixture; the current
committed fixture (Node v24.14.0) is superseded for merge purposes.
...
= 93985841 in the committed fixture), and fails closed on malformed or missing
...
5. The committed live fixture was generated under Node v24.14.0. The runtime
   contract pins **Node v22.23.2**; the fixture is therefore
   **SUPERSEDED_PENDING_NODE22_REGEN** and must be regenerated by a real live
   smoke under Node v22.23.2 before it counts as merge evidence. The fixture
   metadata was not falsified.
...
- Merge gate: the fixture is **SUPERSEDED_PENDING_NODE22_REGEN** (generated
  under Node v24.14.0 vs the v22.23.2 contract pin). Live status
  `P0_LIVE_ACCEPTED_CANDIDATE` remains supported by the audit but the final
  merge evidence must come from a Node v22.23.2 run.
